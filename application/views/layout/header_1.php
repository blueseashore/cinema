...
<div id="menu">
    ...
    <ul>
        <li class="nav_index menu_cur"><a href="<?=$this->config->item('base_url')?>"><i></i><span>首页</span><b></b>
                <div class="clear"></div>
            </a></li>
        <li class="nav_site"><a href="<?=$this->config->item('base_url')?>/cinema/subcriberlist"><i></i><span>我的收藏</span><b></b>
                <div class="clear"></div>
            </a></li>
        <li class="nav_help"><a href="<?=$this->config->item('base_url')?>/cinema/watched"><i></i><span>已看完</span><b></b>
                <div class="clear"></div>
            </a></li>
        <li class="nav_about"><a href="<?=$this->config->item('base_url')?>/cinema/logout"><i></i><span>推出登陆</span><b></b>
                <div class="clear"></div>
            </a></li>
    </ul>
</div>
